...
class MPCController:
    ...
    def _create_cost_weight(self):
        ...
        """
        cost_weight = casadi.SX.zeros((18,18))
        #rope turning weight
        cost_weight[0:3,0:3] = 0.25*casadi.SX.eye(3) * self.weight_turn
        cost_weight[0:3,3:6] = -0.5*casadi.SX.eye(3) * self.weight_turn
        cost_weight[0:3,6:9] = 0.25*casadi.SX.eye(3) * self.weight_turn
        cost_weight[3:6,0:3] = -0.5*casadi.SX.eye(3) * self.weight_turn
        cost_weight[3:6,3:6] = 1.0*casadi.SX.eye(3) * self.weight_turn
        cost_weight[3:6,6:9] = -0.5*casadi.SX.eye(3) * self.weight_turn
        cost_weight[6:9,0:3] = 0.25*casadi.SX.eye(3) * self.weight_turn
        cost_weight[6:9,3:6] = -0.5*casadi.SX.eye(3) * self.weight_turn
        cost_weight[6:9,6:9] = 0.25*casadi.SX.eye(3) * self.weight_turn
        #motion weight.
        cost_weight[15:18,12:15] = 0.5*casadi.SX.eye(3)
        cost_weight[12:15,15:18] = 0.5*casadi.SX.eye(3) 
